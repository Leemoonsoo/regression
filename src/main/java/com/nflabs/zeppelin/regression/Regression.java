package com.nflabs.zeppelin.regression;
...
public class Regression extends Application {
  ...
  public void run(ApplicationArgument arg, InterpreterContext context) throws ApplicationException,
    ...
    context.out.writeResource("regression/Regression.html");
  ...
  private static String generateData() throws IOException {
    InputStream ins = ClassLoader.getSystemResourceAsStream("regression/mockdata.txt");
  ...
  public static void main(String [] args) throws Exception {
    ...
    ZeppelinApplicationDevServer dev = new ZeppelinApplicationDevServer(Regression.class.getName());
